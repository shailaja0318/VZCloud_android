/**
 * Test URL: https://jira.synchronoss.net:8443/jira/browse/IV-2188
 *
 * @author Alen Kalac
 */
...
public class DocumentsSortByExtension extends BaseTestClass {
	private List<WebElement> allElements;
	private List<String> unsortedData;
	private List<String> sortedData;

	@Test
	public void testDocumentsSortByExtension() throws Exception {

		String sort_option = vz_strings.sort_extension;
