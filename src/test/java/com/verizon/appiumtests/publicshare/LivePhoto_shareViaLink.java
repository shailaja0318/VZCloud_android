...
public class LivePhoto_shareViaLink extends BaseTestClass {

   @Test
    public void testLivePhoto_shareViaLink () throws Exception {

        homeScreenView.navigateTo(vz_strings.navi_Photosandvideos);
        photosAndVideosView.selectTab(vz_strings.tab_all);
        baseControlsHelper.clickOnLabelLike("Live Photos");
