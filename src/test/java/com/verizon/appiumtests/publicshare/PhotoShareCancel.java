...
public class PhotoShareCancel extends BaseTestClass {

	@Test
	public void testPhotoShareCancel() throws Exception {
		...
		Thread.sleep(2000);
		baseControlsHelper.waitForShow(vz_strings.button_close_Share);
		TestCase.assertTrue("close Share button is not present ", baseControlsHelper.getCountById(vz_strings.button_close_Share)>0);
		baseControlsHelper.clickOn(vz_strings.button_close_Share);
