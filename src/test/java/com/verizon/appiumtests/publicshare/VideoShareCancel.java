...
public class VideoShareCancel extends BaseTestClass {

   @Test
    public void testVideoShareCancel() throws Exception {
		...
		baseControlsHelper.clickOn(vz_strings.button_noCancelMyShare);
