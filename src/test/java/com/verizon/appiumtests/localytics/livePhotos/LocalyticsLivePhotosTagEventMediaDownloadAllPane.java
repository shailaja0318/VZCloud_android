...
public class LocalyticsLivePhotosTagEventMediaDownloadAllPane extends BaseTestClass {
    ...
    public void testLocalyticsLivePhotosTagEventMediaDownload() throws Exception {
        ...
        TestCase.assertEquals(vz_strings.logs_mediaType + " does not exist", 1, localyticsHelper.getPatternMatch(logs, "\"" + vz_strings.logs_mediaType + "\"" + " = " + "\"" + vz_strings.name_livePhoto_index + "\""));
