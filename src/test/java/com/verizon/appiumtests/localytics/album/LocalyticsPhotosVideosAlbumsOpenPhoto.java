...
public class LocalyticsPhotosVideosAlbumsOpenPhoto extends BaseTestClass {
	...
	public void testLocalyticsPhotosVideosAlbumsOpenPhoto() throws Exception {
		...
		TestCase.assertTrue("Localytics of " + vz_strings.logs_page + " does not exist", localyticsHelper.getPatternMatch(logs, vz_strings.logs_page + " = " + "\"" + vz_strings.logs_photosVideosAlbums + "\"") == 1);
