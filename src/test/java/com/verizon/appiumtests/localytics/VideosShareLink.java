...
public class VideosShareLink extends BaseTestClass {
    ...
    public void testVideoShareLink() throws Exception {
        ...
        TestCase.assertEquals("Localytics of " + vz_strings.logs_shareContentType + " does not exist", 1, localyticsHelper.getCountOf(logs, "\"" + vz_strings.logs_shareContentType + "\"" + " = " + vz_strings.logs_mediaTypeVideo));
