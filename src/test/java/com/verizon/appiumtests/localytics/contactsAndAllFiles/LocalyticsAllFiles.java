...
public class LocalyticsAllFiles extends BaseTestClass {
    ...
    public void testLocalyticsAllFiles() throws Exception {
        ...
        TestCase.assertEquals("Localytics of " + vz_strings.logs_allFiles + " is not 1 in logs", 1, localyticsHelper.getPatternMatch(logs, vz_strings.logs_tagScreen + ": " + vz_strings.logs_allFiles));
