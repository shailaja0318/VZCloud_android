...
public class MusicFavoritesSelectAllPlayPlaylist extends BaseTestClass {
    ...
    public void testMusicFavoritesSelectAllPlayPlaylist() throws Exception {
        ...
        TestCase.assertEquals("Localytics of " + vz_strings.logs_tagEvent + " is not 1 in logs", 1, localyticsHelper.getCountOf(logs, vz_strings.logs_tagEvent + ": " + vz_strings.logs_libraryMenuOptionClicked));
