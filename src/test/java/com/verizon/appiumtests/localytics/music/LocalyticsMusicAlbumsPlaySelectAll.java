...
public class LocalyticsMusicAlbumsPlaySelectAll extends BaseTestClass {

    @Test
    public void testLocalyticsMusicAlbumsPlaySelectAll() throws Exception {

    	homeScreenView.navigateTo(vz_strings.navi_music);
        musicView.selectTab(vz_strings.tab_albums);
        listView.selectFirstItem10();
        listView.clickOnAllElementsInMusicList(vz_strings.MusicView.Album);
