...
public class FavoriteItemAddedVideo extends BaseTestClass {

    @Test
    public void testFavoriteItemAddedVideo() throws Exception {
        ...
        TestCase.assertTrue("Localytics of " + vz_strings.logs_photosVideosAlbums + " does not exist", localyticsHelper.isExisted(logs, vz_strings.logs_count + " = " + "1"));
        TestCase.assertTrue("Localytics of " + vz_strings.logs_mediaType + " does not exist", localyticsHelper.isExisted(logs, "\"" + vz_strings.logs_mediaType + "\"" + " = " + vz_strings.logs_mediaTypeVideo));
