...
public class PhotosVideosMediaGalleryOpenStory extends BaseTestClass {
    ...
    public void testPhotosVideosMediaGalleryOpenStory() throws Exception {
        ...
        TestCase.assertTrue("Localytics of " + vz_strings.logs_tagEvent + " is not 1 in logs", localyticsHelper.getCountOf(logs, vz_strings.logs_tagEvent + ": " + vz_strings.logs_mediaGalleryOpen) == 1);
