...
public class SettingsWhatToBackUpTurnOffVideos extends BaseTestClass {
    ...
    public void testSettingsWhatToBackUpTurnOffVideos() throws Exception {
        try {
            ...
            TestCase.assertTrue(vz_strings.logs_whatToBackupVideos + " does not exist", localyticsHelper.getPatternMatch(logs, "\"" + vz_strings.logs_whatToBackupVideos + "\"" + " = " + vz_strings.logs_no) == 1);
        } finally {
