...
public class BackUpVideosNo extends BaseTestClass {

    @Test
    public void testBackUpVideosNo() throws Exception {
        ...
        TestCase.assertTrue(vz_strings.logs_whatToBackupVideos + " does not exist",
                localyticsHelper.getPatternMatch(logs, "\"" + vz_strings.logs_whatToBackupVideos + "\"" + " = " + vz_strings.logs_no) == 1);
    }
}
