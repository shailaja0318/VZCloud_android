//https://jira.synchronoss.net:8443/jira/browse/VZNFT-413
...
public class MailSettingsFromBackground extends BaseTestClass {
    private final static Logger logger = LogManager.getLogger(MethodHandles.lookup().lookupClass());

    @Test
    public void testMailSettingsFromBackground() throws Exception {
