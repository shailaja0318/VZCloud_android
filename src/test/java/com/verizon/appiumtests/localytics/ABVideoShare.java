...
public class ABVideoShare extends BaseTestClass{
	...
	public void testABVideoShare() throws Exception {
		...
		TestCase.assertTrue("Localytics of " + vz_strings.logs_shareContentType + " does not exist", localyticsHelper.getCountOf(logs, "\"" + vz_strings.logs_shareContentType + "\"" + " = " + vz_strings.logs_mediaTypeVideos) == 1);
