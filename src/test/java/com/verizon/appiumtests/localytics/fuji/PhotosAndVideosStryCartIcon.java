...
public class PhotosAndVideosStryCartIcon extends BaseTestClass {
    ...
    public void photosAndVideosStoryCartIcon() throws Exception {
        ...
        TestCase.assertEquals("Localytics of " + vz_strings.logs_photoBucketEntryPoint + " does not exist", 1, localyticsHelper.getPatternMatch(logs, "\"" + vz_strings.logs_photoBucketEntryPoint + "\" = \"" + vz_strings.logs_story_scenes + "\""));
