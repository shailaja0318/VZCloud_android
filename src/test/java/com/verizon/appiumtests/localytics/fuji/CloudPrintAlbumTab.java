...
public class CloudPrintAlbumTab extends BaseTestClass {
    ...
    public void cloudPrintAlbum() throws Exception {
        ...
        TestCase.assertTrue("Localytics of " + vz_strings.logs_photoBucketEntry + " does not exist", localyticsHelper.getPatternMatch(logs, vz_strings.logs_photoBucketEntry)==1);
