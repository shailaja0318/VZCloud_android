 ...
 */
public class StorySearchTitle extends BaseTestClass {
  //  @Test
    public void storySearchTitle_IV_2386() throws Exception {
        homeScreenView.navigateTo(vz_strings.navi_Photosandvideos);
        photosAndVideosView.selectTab(vz_strings.tab_stories);
        if (baseControlsHelper.getCountById(vz_strings.emptyPhotosViewIcon) == 0) {
            TestCase.assertTrue("Stories are not displaying proper", photosAndVideosView.search("title"));
        } else
