...
public class FilterByVideos extends BaseTestClass {
    ...
    public void testFilterByVideos() throws Exception {
        ...
        TestCase.assertTrue("Didn't find Filter header",
                baseControlsHelper.getCountByXpath(vz_strings.filter_FilteredByVideos)>0);
        TestCase.assertEquals("Clear filter is not available", 1,
                baseControlsHelper.getCountByXpath(vz_strings.filter_clear));
